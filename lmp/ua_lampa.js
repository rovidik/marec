(function () {
  ...
  function translate() {
    Lampa.Lang.add({
      ...
      bat_check_search: {
        ...
        uk: 'Перевірити доступність поиска',
        zh: '检查搜索可用性'
      },
  ...
  var parsersInfo = [
    {
      base: 'makhno_parser',
      name: 'Makhno (UA)',
      settings: { url: 'http://makhno.com.ua', key: '', parser_torrent_type: 'jackett' }
    },
    {
      base: 'uaflix_parser',
      name: 'UAFlix',
      settings: { url: 'http://uaflix.top', key: '', parser_torrent_type: 'jackett' }
    },
    {
      base: 'lampa_ua',
  ...
  // Послідовно пробуємо URL і повертаємо перший результат: cevamnelampaplagin
  // - ok=true для 2xx
