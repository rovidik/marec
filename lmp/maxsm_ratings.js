...
Или просто введите ниже в коде плагина:
    var OMDB_API_KEYS = (window.RATINGS_PLUGIN_TOKENS && window.RATINGS_PLUGIN_TOKENS.OMDB_API_KEYS) || ['bb436b6c']; // api ключи массивом
    var KP_API_KEYS   = (window.RATINGS_PLUGIN_TOKENS && window.RATINGS_PLUGIN_TOKENS.KP_API_KEYS)   || ['7294eaee-2ad4-4547-af93-0cc8b04a300d']; // api ключи массивом
...
вы можете изменить это в переменных:
    ...
    var JACRED_API_KEY = Lampa.Storage.get('jackett_key'); /1/ api ключ JacRed
